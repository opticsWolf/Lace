...
DOCK_THEMES: Dict[str, Dict[DockStyleCategory, Dict[str, Any]]] = {
    ...
    "light": {
        DockStyleCategory.CORE: {
            "canvas_bg":          [246, 246, 246, 255],
            "border_color":       [218, 218, 218, 255],
