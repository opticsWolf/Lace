...
# =============================================================================
# THEME DEFINITIONS - Only 3 colors each! (see ThemeSpec)
# =============================================================================
...
DOCK_THEMES: Dict[str, Dict[DockStyleCategory, Dict[str, Any]]] = {
    ...
    # -------------------------------------------------------------------------
    "midnight": build_theme(ThemeSpec(
